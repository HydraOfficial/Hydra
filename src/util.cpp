...
int nAnonymizeHydraAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "hydra.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "hydrad.pid"));

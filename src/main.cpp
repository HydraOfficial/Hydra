...
const string strMessageMagic = "Hydra Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	else if (nHeight > 100 && nHeight <= 65 * 1000) {
		nSubsidy = 15 * COIN; // initial block reward
	}
	else if (nHeight > 65 * 1000 && nHeight <= 590 * 1000) {
		nSubsidy = 12.5 * COIN;
	}
	else if (nHeight > 590 * 1000 && nHeight <= 1115 * 1000) {
		nSubsidy = 10 * COIN;
	}
	else if (nHeight > 1115 * 1000 && nHeight <= 1640 * 1000) {
		nSubsidy = 7.5 * COIN;
	}
	else if (nHeight > 1640 * 1000 && nHeight <= 2165 * 1000) {
		nSubsidy = 5 * COIN;
	}
	else if(nHeight > 2165 * 1000 && nHeight <= 2690 * 1000) {
		nSubsidy = 2.5 * COIN;
	}
	else if (nHeight > 2690 * 1000) {
		nSubsidy = 0 * COIN;
		//End of POW
		//Max POW coins 20662500
	}
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
	...
	if (nHeight > 100 && nHeight <= 3 * 1000) {
		nSubsidy = 0 * COIN;
	}else if (nHeight > 3 * 1000 && nHeight <= 65 * 1000) {
		nSubsidy = 20 * COIN;
	}else if (nHeight > 65 * 1000 && nHeight <= 590 * 1000) {
		nSubsidy = 15 * COIN;
	}else if(nHeight > 590 * 1000) {
		nSubsidy = 10 * COIN;
	}
	return nSubsidy + nFees;
}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
	...
	if (nHeight > 3 * 1000 && nHeight <= 590 * 1000) {
				...
				if(pindex->GetBlockHash() == hashPrevBlock){
					...
					if(!masternodePayments.GetBlockPayee(pindexBest->nHeight+1, payee, vin)){
						...
						if(hasPayment && payeerewardpercent == 0){
							...
							CHydracoinAddress address2(address1);
						...
						if(hasPayment && payeerewardpercent > 0 && payeerewardpercent < 100){
							...
							CHydracoinAddress address4(address3);
							targetNode = address2.ToString().c_str();

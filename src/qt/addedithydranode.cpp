...
AddEditHydraNode::AddEditHydraNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditHydraNode)
{
    ui->setupUi(this);
...
AddEditHydraNode::~AddEditHydraNode()
{
    delete ui;
}


void AddEditHydraNode::on_okButton_clicked()
{
...
void AddEditHydraNode::on_cancelButton_clicked()
{
    reject();
}

void AddEditHydraNode::on_AddEditAddressPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->addressLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditHydraNode::on_AddEditPrivkeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->privkeyLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditHydraNode::on_AddEditTxhashPasteButton_clicked()
{
    // Paste text from clipboard into recipient field

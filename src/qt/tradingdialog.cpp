...
void tradingDialog::ParseAndPopulateOrderBookTables(QString OrderBook){
    ...
    ui->LIZSupply->setText("<b>Supply:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(LIZSupply,'i',8) + "</span><b> xDra</b>");
    ...
    ui->LIZDemand->setText("<b>Demand:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(LIZDemand,'i',8) + "</span><b> xDra</b>");
...
void tradingDialog::ActionsOnSwitch(int index = -1){
    ...
    switch (index){
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("xDra");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->LIZBalanceLabel,*ui->LIZAvailableLabel_2,*ui->LIZPendingLabel, QString::fromUtf8("xDra"),Response);
                    }
                break;

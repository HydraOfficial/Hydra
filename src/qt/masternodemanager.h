...
public slots:
    void updateNodeList();
    void updateHydraNode(QString alias, QString addr, QString privkey, QString txHash, QString txIndex, QString rewardAddress, QString rewardPercentage, QString status);
